...
#region TR ADD #1
    SerializedProperty tSplit;
    SerializedProperty tStartLaneNO;
    SerializedProperty tLaneCount;
    SerializedProperty tLaneWidth;
    SerializedProperty tLaneOffsetY;
#endregion
    ...
    SerializedProperty tTextureSize;
...
#region TR ADD #2
        tSplit = serializedObject.FindProperty("SplitLane");
        tStartLaneNO = serializedObject.FindProperty("StartLaneNO");
        tLaneCount = serializedObject.FindProperty("LaneCount");
        tLaneWidth = serializedObject.FindProperty("LaneWidth");
        tLaneOffsetY = serializedObject.FindProperty("LaneOffsetY");
#endregion
        ...
        tTextureSize = serializedObject.FindProperty("TextureWidth");
    ...
    {   
        ...
        GUI.enabled = true;
#region TR ADD #3
        EditorGUILayout.PropertyField(tSplit, new GUIContent("Split Spline", "Split spline?"));
        EditorGUILayout.PropertyField(tStartLaneNO, new GUIContent("Start Lane NO", "Start lane NO"));
        EditorGUILayout.PropertyField(tLaneCount, new GUIContent("Lane Count", "Lane Count"));
        EditorGUILayout.PropertyField(tLaneWidth, new GUIContent("Lane Width", "Lane Width"));
        EditorGUILayout.PropertyField(tLaneOffsetY, new GUIContent("Lane Offset Y", "Lane Offset Y"));
        GUI.enabled = true;
#endregion
        ...
        EditorGUILayout.LabelField("Texture", EditorStyles.boldLabel);
            ...
            tTextureSize.intValue = EditorGUILayout.IntField("Texture Size", tTextureSize.intValue);
