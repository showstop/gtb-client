...
public class CurvySplineSegmentInspector : Editor {
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (mValid) {
            ...
            EditorGUILayout.LabelField("Segment Granularity : " + Target.mSegmentGranularity);
        }
        ...
        {
            EditorGUILayout.LabelField("Texture UV Setting", EditorStyles.boldLabel);

            Target.TexturePosX = EditorGUILayout.IntField("Texture Pos X", Target.TexturePosX);
            Target.TextureU = (float)Target.TexturePosX / (float)Target.Spline.TextureWidth;
            EditorGUILayout.LabelField("Texture U: " + Target.TextureU);
        }
