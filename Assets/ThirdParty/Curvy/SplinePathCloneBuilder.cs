...
public class SplinePathCloneBuilder : MonoBehaviour
{
    ...
    public void Refresh(bool force)
    {
        ...
        if (count >= MAXCLONES) {
            YPLog.LogError("SplinePathCloneBuilder: MAXCLONES reached, ensure to have proper colliders in place! If you really want to clone more than " + MAXCLONES + " objects, increase MAXCLONES in SplinePathCloneBuilder.cs (Line 15)!");
        }
        else {
