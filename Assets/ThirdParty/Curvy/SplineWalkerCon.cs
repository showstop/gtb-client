...
public class SplineWalkerCon : MonoBehaviour {
    ...
    {
        get { return Spline.TFToDistance(TF); }
        set { mTF = Spline.DistanceToTF(Distance); }
    }
...
#region TR ADD #1    
    ...
    void Update()
    {
        ...
        if (Application.isPlaying) {
            ...
            mTransform.position = Vector3.SmoothDamp(oldPos, newPos, ref mSmoothVelocity, Time.smoothDeltaTime);
...
#region TR ADD #2
        MoveDistance = Vector3.Distance(mTransform.position, oldPos);
        ClampTF = Spline.AriseClampTF;
#endregion
    }
