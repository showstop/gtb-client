...
#region Create
	...
	static public void AddSprite ()
	{
		...
		{
			YPLog.Log("You must select a game object first.");
		}
	}
	...
	static public void AddSprite2D ()
	{
		...
		else YPLog.Log("You must select a game object first.");
	}
#endif
...
#region Attach
	...
	static public void AddCollider ()
	{
		...
		if (NGUIEditorTools.WillLosePrefab(go))
		{
			...
			{
				YPLog.Log("You must select a game object first, such as your button.");
			}
		}
	}
