...
// 		m_bNeedRebuild = true;
	...
	{
//   		YPLog.Log("GetSpriteUvRect() - m_SpriteList.Count = " + m_SpriteList.Count + ", nStriteIndex = " + nStriteIndex + ", nFrameIndex = " + nFrameIndex);
...
//				UpdateUvScale(nNodeIndex, transform);
	...
	void CreateEffectObject()
	{
		...
		if (m_bShowEffect == false)
			return;
		DestroyEffectObject();
// 		YPLog.Log("CreateEffectObject() - new = " + ncSpriteNode.m_EffectPrefab);
...
// 			createEffect.transform.Rotate(ncSpriteNode.m_EffectRot, Space.Self);
	...
	{
//  		YPLog.Log("DestroyEffectObject - " + m_CurrentEffect);
...
// 		YPLog.Log("CreateSoundObject");
	...
	{
// 		YPLog.Log("OnChangingSprite() - nOldNodeIndex = " + nOldNodeIndex + ", nNewNodeIndex = " + nNewNodeIndex);
	...
	{
// 		YPLog.Log("OnAnimationChangingFrame() - nOldIndex = " + nOldIndex + ", nNewIndex = " + nNewIndex + ", nLoopCount = " + nLoopCount + ", m_nCurrentIndex = " + m_nCurrentIndex);
...
// 		m_fFps	*= fSpeedRate;
	...
	{
// 		YPLog.Log(ncSpriteFrameInfo.m_FrameUvOffset);
...
//  			YPLog.Log(meshFilter.mesh.vertices[n]);
	}
