...
public class NgTexture
{
	...
	public static void UnloadTextures(GameObject rootObj)
	{
		...
		foreach (Renderer ren in rens)
		{
			...
			{
				YPLog.Log("UnloadTextures - " + ren.material.mainTexture);
	...
	public static Texture2D CombineTexture(Texture2D baseTexture, Texture2D combineTexture)
	{
		...
		YPLog.LogWarning("need 	Object.DestroyImmediate(returnTexture);");
...
// 		YPLog.Log("srcRect " + srcRect);
// 		YPLog.Log("drawRect " + drawRect);
	...
	{
// 		YPLog.Log("ChangeImportTextureToGUI - " + assetPath);
