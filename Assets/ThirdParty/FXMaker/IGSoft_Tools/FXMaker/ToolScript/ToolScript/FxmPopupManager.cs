...
public class FxmPopupManager : MonoBehaviour
{
	...
	void Awake()
	{
		...
		{
			YPLog.LogError("m_ToolPopupGameObject is null !!!");
		}
...
// 		NgUtil.LogMessage("ToolMessage - " + msg);
	...
	public void ShowHierarchyObjectPopup(string scriptFilename, Object selObj)
	{
		if (scriptFilename != null)
		{
			...
			if (m_CurrentHierarchyPopup == null)
				m_CurrentHierarchyPopup	= UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(m_ToolPopupGameObject, "Assets/ThirdParty/FXMaker/IGSoft_Tools/FXMaker/ToolScript/ToolScript/FxmPopupManager.cs (395,31)", scriptFilename) as FxmPopup;
			if (m_CurrentHierarchyPopup != null)
	...
	bool SetFxmFolderPopup(System.Type fxmFolderPopup)
	{
		...
		if (m_CurrentFolderPopup == null)
			YPLog.LogError("m_CurrentFolderPopup is null");
