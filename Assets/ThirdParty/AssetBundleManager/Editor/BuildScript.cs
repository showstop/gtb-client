...
namespace AssetBundles
{
	public class BuildScript
	{
		...
		public static void BuildAssetBundles()
		{
            ...
            string destPath = Application.streamingAssetsPath + "/" + Utility.GetPlatformName();
            ...
            //BundleCreate & StreamingAssetPath Copy Add
            if(!Directory.Exists(destPath + "/" + Utility.GetPlatformName()))
            {
                Directory.CreateDirectory(destPath);
            }
            AssetBundleLoader.Copy(outputPath, destPath);
		}
