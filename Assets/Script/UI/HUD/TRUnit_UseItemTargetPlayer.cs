...
public class TRUnit_UseItemTargetPlayer : MonoBehaviour 
{
    [SerializeField]
    private TRPanel_UseItem _useItemPanel;

    [SerializeField]
    private UITexture   m_targetPlayerAvatar;
	public Texture TargetPlayerAvatar
	{
		set	{	if ( null != value )	{	m_targetPlayerAvatar.mainTexture = value;	}	}
	}

	[SerializeField]
	private UILabel 	m_targetPlayerName;	

	[SerializeField]
	private UILabel 	m_targetPlayerRank;
	...
	[SerializeField]
	private UISprite	m_targetPlayerHP;
    ...
    internal void SetupTargetPlayer(CarController aTarget, float aOffsetY, bool aJamming)
    {
        ...
        //else
        //{
        //    TargetPlayerAvatar = TRPlatformWrapper.Instance.GetPlayerImage(PlayerUUID, delegate(Texture texture) { TargetPlayerAvatar = texture; }, Constants.EMPTY_STRING, true);
        //    m_targetPlayerName.text = TRPlatformWrapper.Instance.GetPlayerName(PlayerUUID, delegate(string buffer) { m_targetPlayerName.text = buffer; }, Constants.EMPTY_STRING);
        //}
    }
