...
{	
  ...
  var blurPreview : SerializedProperty;
  ...
  //var dynamicLayers : SerializedProperty;
    ...
    blurPreview = serObj.FindProperty ("preview");
  ...
  function OnInspectorGUI () {         
    ...
    EditorGUILayout.PropertyField (blurPreview, new GUIContent("Preview"));
    if (blurPreview.boolValue)
